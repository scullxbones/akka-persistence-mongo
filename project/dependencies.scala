...
object Dependencies {
  ...
  val akkaPersistTck = "com.github.krasserm" %% "akka-persistence-testkit" % "0.3.1" % "test"

  val akkaPersistence = "com.typesafe.akka" %% "akka-persistence-experimental" % "2.3.2" % "provided"
