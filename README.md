 ...
 * Only supports akka persistence version `2.3.x`.  The `2.4.x` series is unsupported for now, but is under development.
 ...
 * Cross compiled to `2.11` and `2.10` series.  When `2.12` is released, will drop support for `2.10`.
