...
lazy val `akka-persistence-mongo-scala` = (project in file("scala"))
  ...
  .settings(
    libraryDependencies ++= Seq(
      ...
      "io.netty"          % "netty-buffer"        % "4.1.45.Final" % "compile",
      "io.netty"          % "netty-transport"     % "4.1.45.Final" % "compile",
      "io.netty"          % "netty-handler"       % "4.1.45.Final" % "compile",
  ...
  .settings(
    libraryDependencies ++=
      Seq("reactivemongo", "reactivemongo-akkastream")
        .map("org.reactivemongo" %% _ % "0.19.5" % "compile")
